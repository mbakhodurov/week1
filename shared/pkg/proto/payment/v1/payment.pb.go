...
type PayOrderRequest struct {
	...
	PaymentMethod PaymentMethod          `protobuf:"varint,3,opt,name=payment_method,json=paymentMethod,proto3,enum=inventory.v1.PaymentMethod" json:"payment_method,omitempty"`
...
const file_payment_v1_payment_proto_rawDesc = "" +
	"\n" +
	"\x18payment/v1/payment.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xa5\x01\n" +
	"\x0fPayOrderRequest\x12'\n" +
	"\n" +
	"order_uuid\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\torderUuid\x12%\n" +
	"\tuser_uuid\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\buserUuid\x12B\n" +
	"\x0epayment_method\x18\x03 \x01(\x0e2\x1b.inventory.v1.PaymentMethodR\rpaymentMethod\"=\n" +
	...
	"\x0eINVESTOR_MONEY\x10\x042\x81\x01\n" +
	"\x0ePaymentService\x12o\n" +
	"\bPayOrder\x12\x1d.inventory.v1.PayOrderRequest\x1a\x1e.inventory.v1.PayOrderResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/api/v1/payment/pay_orderBOZMgithub.com/mbakhodurov/homeworks/week1/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
...
var file_payment_v1_payment_proto_goTypes = []any{
	(PaymentMethod)(0),       // 0: inventory.v1.PaymentMethod
	(*PayOrderRequest)(nil),  // 1: inventory.v1.PayOrderRequest
	(*PayOrderResponse)(nil), // 2: inventory.v1.PayOrderResponse
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	0, // 0: inventory.v1.PayOrderRequest.payment_method:type_name -> inventory.v1.PaymentMethod
	1, // 1: inventory.v1.PaymentService.PayOrder:input_type -> inventory.v1.PayOrderRequest
	2, // 2: inventory.v1.PaymentService.PayOrder:output_type -> inventory.v1.PayOrderResponse
